...
from torch.utils.data import RandomSampler,SubsetRandomSampler,DistributedSampler
import logging
...
# Args -- Experiment
# CTR
import bert as dataloader
import bert_adapter_capsule_mask as approach
import bert_adapter_capsule_mask_net as network
...
# ----------------------------------------------------------------------
print('Load data...')
# data : TensorDataset , taskcla (task_id,class_num)
...
if not args.eval_each_step: # store_true
    resume_checkpoint(appr,net)

if args.print_report:   # store_true
